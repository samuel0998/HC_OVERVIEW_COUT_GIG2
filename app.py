...
def _migrate_hc_table_for_fc(fc):
    ...
    with engine.begin() as conn:
        ...
        conn.execute(db.text("ALTER TABLE hc_gig2 ADD COLUMN IF NOT EXISTS presente_fc BOOLEAN DEFAULT FALSE"))
        conn.execute(db.text("ALTER TABLE hc_gig2 ALTER COLUMN presente_fc SET DEFAULT FALSE"))
        conn.execute(db.text("UPDATE hc_gig2 SET presente_fc = FALSE WHERE presente_fc IS NULL"))
